        ...
        >
          ...
          <div className="mt-6 flex flex-col gap-2">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-lg border border-white/10 bg-white/5 py-2.5 text-sm text-white hover:bg-white/10 transition-colors"
            >
